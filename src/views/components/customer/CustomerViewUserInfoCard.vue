      ...
      >
        <table class="mt-2 mt-xl-0 w-100">
          ...
          <tr>
            <th class="pb-50">
              <feather-icon
                ...
                class="mr-75"
              />
              <span class="font-weight-bold">Gidilen KM</span>
            </th>
          ...
          <tr>
            <th class="pb-50">
              <feather-icon
                ...
                class="mr-75"
              />
              <span class="font-weight-bold">Toplam Yolculuk</span>
            </th>
            <td class="pb-50 text-capitalize">
          ...
          <tr>
            ...
            <td class="pb-50 text-capitalize">
              <a :href="'tel:' + userData.general.phone">{{ userData.general.phone }}</a>
            </td>
          </tr>
        </table>
      </b-col>
...
export default {
  ...
  computed: {
    totalKm() {
      let total = 0
      this.userData.trip.reduce((acc, cur) => {
        total = +cur.distance
      }, 0)
      return total
    },
    ...
    totalTrips() {
      return this.userData.trip.length
    },
  },
