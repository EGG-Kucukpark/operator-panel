...
export default {
  ...
  methods: {
    veri() {
      this.$http.get('/customer/subsActive', { params: { disabled: false } }).then(response => {
    ...
    goTo(data) {
      this.$store.commit('general/user', data)
      this.$router.push('/musteri-bilgileri')
    },
    closeModal() {
